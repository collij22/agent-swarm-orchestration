...
try:
#    from rich.console import Console  # Disabled Rich
#    from rich.panel import Panel  # Disabled Rich
#    from rich.progress import Progress, SpinnerColumn, TextColumn, BarColumn, TimeElapsedColumn  # Disabled Rich
#    from rich.table import Table  # Disabled Rich
#    from rich.prompt import Prompt, Confirm  # Disabled Rich
    HAS_RICH = False
except ImportError:
    HAS_RICH = False
